...
config.General.requestName = 'TnPPairTrees_2017C_V02'
...
config.Data.outLFNDirBase = '/store/user/%s/TnPPairTrees_2017C_V02/' % (getUsernameFromSiteDB())
config.Data.publication = False
config.Data.outputDatasetTag = 'TnPPairTrees_2017C_V02'
