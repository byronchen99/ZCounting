...
config.General.requestName = 'TnPPairTrees_2017H_LowPU_V02'
...
config.Data.outLFNDirBase = '/store/user/%s/TnPPairTrees_2017H_LowPU_V02/' % (getUsernameFromSiteDB())
config.Data.publication = False
config.Data.outputDatasetTag = 'TnPPairTrees_2017H_LowPU_V02'
