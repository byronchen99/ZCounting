...
config.General.requestName = 'TnPPairTrees_2017E_V02'
...
config.Data.inputDataset = '/SingleMuon/Run2017E-09Aug2019_UL2017-v1/AOD'
...
config.Data.runRange = '303435-304826'
config.Data.outLFNDirBase = '/store/user/%s/TnPPairTrees_2017E_V02/' % (getUsernameFromSiteDB())
config.Data.publication = False
config.Data.outputDatasetTag = 'TnPPairTrees_2017E_V02'
