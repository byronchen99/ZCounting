...
config.General.requestName = 'DY50_Summer16_V06'
...
config.Data.outLFNDirBase = '/store/user/%s/ZCountAnalyze_V06/' % (getUsernameFromSiteDB())
config.Data.publication = False
config.Data.outputDatasetTag = 'DY50_Summer16_V06'
