...
for fill in fills:
	...
	graph_atlas.SetMarkerColor(kGreen-4)
	...
	graph_ratioE.GetYaxis().SetTitle("CMSNew/CMS")
	...
	graph_atlascmsratio.GetYaxis().SetTitle("CMSnew/CMS")
	...
	graph_atlasinstLum.SetMarkerColor(kGreen)
...
#	print str(splAtl.integral(cmsTimes[6],cmsTimes[7]))
	...
	legend.AddEntry(graph_atlas,"CMS new","p")
	...
	graph_atlasXsec2.SetMarkerColor(kGreen-4)
...
graph_metaatlasXsec.SetMarkerColor(kGreen-4)
...
graph_metaZIntLumi.SetMarkerColor(kGreen)
graph_metaZIntLumi.SetMarkerSize(2)
graph_metaZIntLumi.GetXaxis().SetTitle("Fill")
graph_metaZIntLumi.GetYaxis().SetTitle("Z Int. Luminosity Ratio CMSnew/CMS")
