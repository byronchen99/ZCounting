...
# ------------------------------------------------------------------------------
def make_plots(data, ZXSec, relstat, xAxis='lumi',run_range=None, xTitle="instantaneous recorded luminosity [Hz/pb]", title="", plot_fills=False, nround=0, normalized=False):
    """
...
#
# make_plots(data, "xsec",      'z_relstat',   title="Z rate / lumi - 2017C", run_range=(299368,302029), normalized=True)
# make_plots(data, "xsec_mc",   'z_relstat',   title="Z rate / lumi - 2017C", run_range=(299368,302029))
make_plots(data, "xsecBB_mc", 'zBB_relstat', title="corrected Z BB rate / lumi - 2017C", run_range=(299368,302029), normalized=True)
make_plots(data, "xsecBE_mc", 'zBE_relstat', title="corrected Z BE rate / lumi - 2017C", run_range=(299368,302029), normalized=True)
make_plots(data, "xsecEE_mc", 'zEE_relstat', title="corrected Z EE rate / lumi - 2017C", run_range=(299368,302029), normalized=True)

make_plots(data, "xsecBB_mc", 'zBB_relstat', title="corrected Z BB rate / lumi - 2017D", run_range=(302030,303434), normalized=True)
make_plots(data, "xsecBE_mc", 'zBE_relstat', title="corrected Z BE rate / lumi - 2017D", run_range=(302030,303434), normalized=True)
make_plots(data, "xsecEE_mc", 'zEE_relstat', title="corrected Z EE rate / lumi - 2017D", run_range=(302030,303434), normalized=True)

make_plots(data, "xsecBB_mc", 'zBB_relstat', title="corrected Z BB rate / lumi - 2017E", run_range=(303434,304797), normalized=True)
make_plots(data, "xsecBE_mc", 'zBE_relstat', title="corrected Z BE rate / lumi - 2017E", run_range=(303434,304797), normalized=True)
make_plots(data, "xsecEE_mc", 'zEE_relstat', title="corrected Z EE rate / lumi - 2017E", run_range=(303434,304797), normalized=True)
