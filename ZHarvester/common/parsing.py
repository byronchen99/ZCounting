...
def parser_zharvest(pars=None):
    ...
    pars.add_argument("-si", "--secondinput", default="/eos/cms/store/group/comm_luminosity/ZCounting/2022/DQMFiles/cmsweb.cern.ch/dqm/offline/data/browse/ROOT/OfflineData/Run2023/",
                        help="Second directory to the input files from the DQM Offline module")
