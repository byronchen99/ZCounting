...
parser.add_argument("-g","--dirMCReweight",help="Directory to root files for pilupe reweighting",default=cmssw+"./Resources/ReweightHistogram/")
parser.add_argument("-t","--dirMCShape",help="Directory to root file for Z mass template",default="./Resources/92X_norw_IsoMu27_noIso_MuStaEff_probes.root")
